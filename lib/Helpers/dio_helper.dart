...
class DioHelper{
  ...
  Future<List<NewsModel>> getAllNews()async{
    Response responseAll = await dio.get('https://newsapi.org/v2/everything?q=every&from=2022-08-25&sortBy=popularity&apiKey=83d0a4bfd1434a3ba393eaa97001f158');
  ...
  getDiscoverNews(String discover)async{
    Response responseDiscover = await dio.get('https://newsapi.org/v2/everything?q=$discover&from=2022-08-23&sortBy=popularity&apiKey=83d0a4bfd1434a3ba393eaa97001f158');
  ...
  getSearchNews(String searchTitle)async{
    Response responseSearch = await dio.get('https://newsapi.org/v2/everything?q=$searchTitle&from=2022-08-10&sortBy=popularity&apiKey=83d0a4bfd1434a3ba393eaa97001f158');
