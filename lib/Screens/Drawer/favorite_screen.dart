    ...
    return Scaffold(
      ...
      body: Consumer<DbProvider>(
          builder: (context,provider,x) {
            return
              provider.favoritesNews.isEmpty?
                  ...
                  itemBuilder: (context,index){
                    return Column(
                      children: [
                        InkWell(
                          onTap: ()async{
                            var url = Uri.parse(provider.favoritesNews[index].url!);
                            try{
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                        ...
                                        height: 200.h,
                                        fit: BoxFit.fill,
                                        imageUrl: provider.favoritesNews[index].image??"https://play-lh.googleusercontent.com/blO52aLoIwSmO6mYe7cL2ZxV6zhPDC7--AdpcSkVrpPaeZJouPrbaD6Iz51VNdmu9Vc",
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                        onTap:(){
                                          provider.deleteNews(provider.favoritesNews[index].id!);
                                        },
                                        child:const Icon(Icons.favorite,color: Colors.grey,size: 25,)
                                    ),
                                    Icon(Icons.bookmark_add_outlined,color: Colors.grey,size: 25,),
                                    InkWell(
                                        onTap: ()async{
                                          await Share.share('${provider.favoritesNews[index].title??'no Title'}\n${provider.favoritesNews[index].url??'no Link'}' );
                                        },
