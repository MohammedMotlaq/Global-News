                      ...
                      children: [
                        InkWell(
                          onTap: ()async{
                            ...
                            try{
                              await canLaunchUrl(url)? await launchUrl(url,mode: LaunchMode.inAppWebView): throw 'Could not open URL';
                            }catch(e){
                              log(e.toString());
                            }
                          },
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                        ...
                                        height: 200.h,
                                        fit: BoxFit.fill,
                                        imageUrl: provider.news[index].urlToImage??"https://play-lh.googleusercontent.com/blO52aLoIwSmO6mYe7cL2ZxV6zhPDC7--AdpcSkVrpPaeZJouPrbaD6Iz51VNdmu9Vc",
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap:(){
                                        // isLike = !isLike;
                                        // isLike == true ? iconLove='assets/icons/lovered.png':iconLove='assets/icons/lovegrey.png';
                                        // dbProvider.getLikeAndIcon(isLike, iconLove);
                                        // if(dbProvider.like == true){
                                        //
                                        // }
                                      ...
                                      child:Image.asset('assets/icons/lovegrey.png',width: 32.w,height: 32.h,)
                                    ),
                                    InkWell(
                                      onTap: ()async{
                                        await Share.share('${provider.news[index].title??'no Title'}\n${provider.news[index].url??'no Link'}' );
                                      },
                                      child:Image.asset('assets/icons/share.png',width: 28.w,height: 28.h,)
                                    ),
                                  ],
                                ),
                              ),
