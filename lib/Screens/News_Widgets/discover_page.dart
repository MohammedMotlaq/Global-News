                    ...
                    child: Stack(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(cats[index]['image'],fit: BoxFit.cover,width: 180.w,height: 180.h,)
                        ),
                        Text(cats[index]['name'],style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ),
                ),
